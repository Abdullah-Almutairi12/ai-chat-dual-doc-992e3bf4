...
const en = {
  ...
  pdf_process_failed: "Processing failed. Try a different file or tool.",
  pdf_output_invalid: "The output file was invalid. Please try again.",
  pdf_batch_too_large: "Too many files or total size exceeds the limit.",
  pdf_vision_fallback: "Vision AI unavailable — using standard conversion.",
  pdf_vision_not_configured: "Cloud AI is not configured on this server. Add OPENAI_API_KEY in Vercel (pdfquanta.online project).",
  pdf_vision_active: "Converting with cloud Vision AI…",
...
const ar: Record<keyof typeof en, string> = {
  ...
  pdf_process_failed: "فشت المعالجة. جرّب ملفاً أو أداة أخرى.",
  pdf_output_invalid: "ملف الناتج غير صالح. يرجى المحاولة مرة أخرى.",
  pdf_batch_too_large: "عدد الملفات أو الحجم الإجمالي يتجاوز الحد المسموح.",
  pdf_vision_fallback: "الذكاء البصري غير متاح — سيتم استخدام التحويل القياسي.",
  pdf_vision_not_configured: "الذكاء الاصطناعي السحابي غير مُفعّل على الخادم. أضف OPENAI_API_KEY في Vercel (مشروع pdfquanta.online).",
  pdf_vision_active: "جارٍ التحويل بالذكاء الاصطناعي السحابي…",
